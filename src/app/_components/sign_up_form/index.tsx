    ...
    <div>
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input type="email" name="email" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="john@example.com" required />
        </div>
        <div className="mb-6">
      ...
      <div className="bg-white py-4">OR</div>
      <form
        action={async () => {
          "use server"
          await signIn("github")
