...
const CoreTeamWidget = () => {
  return (
    <>
      ...
      />
      <div className='m-auto max-w-[1340px] sm:grid md:grid-cols-2 lg:grid-cols-3 mb-8 lg:mb-16 p-6 bg-stone-800 text-white rounded-2xl '>
        <div className='md:border-b pb-6 md:p-6 pl-px pt-px border-stone-700'>
        ...
        <div className='md:border-b md:border-r md:border-l p-6 border-stone-700'>
        ...
        <div className='md:border-b p-6 hidden lg:block border-stone-700'>
        ...
        <div className='md:border-b md:border-r md:border-l p-6 text-right border-stone-700'>
          <dl className='text-md md:text-lg'>
        ...
        <div className='md:border-b py-6 md:p-6 pr-px border-stone-700'>
          <div className='rounded-xl overflow-hidden h-full w-full'>
            <Image
              src='/assets/mp.jpg'
              alt='logo'
        ...
        <div className='md:border-r md:border-l p-6 border-stone-700'>
          <dl className='text-md md:text-lg'>
