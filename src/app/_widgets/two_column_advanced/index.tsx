        ...
        return (
          <div key={i} className='flex flex-row gap-6 md:px-6 md:items-center border-t'>
            ...
            <div className='p-8 flex flex-col self-stretch md:border-l md:pt-16'>
              <h2 className='block text-4xl font-normal md:text-5xl md:mb-8 leading-loose'>{title}</h2>
              <h3 className='md:hidden text-2xl font-normal md:text-3xl mb-4 md:mb-8'>{subtitle}</h3>
