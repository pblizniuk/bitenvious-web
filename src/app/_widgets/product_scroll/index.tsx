    ...
    '>
        <div className='flex flex-row pt-8'>
          {productScroll?.length && productScroll.map((item) => {
            ...
            return (
              <div key={item.id} className='group cta w-[calc(100vw-max(48px,min(4.44vw,64px)))] max-w-[435px] md:w-scroll-column px-6 shrink-0 first:ml-8 last:mr-8 snap-center relative'>
                <Image
                  src={item.Image.url}
                  alt={item.Title}
                  width={220}
