      ...
      <div className='relative m-auto w-full max-w-[1340px] flex p-8 text-center md:p-12 md:text-right lg:my-24 lg:px-16'>
        <div className='about-logo relative flex items-center mx-auto'>
          <div className="relative">
            ...
            />
            <div className='animate-pulse absolute end-0 top-0 z-10 h-[250px] w-[250px] rounded-full bg-stone-800 dark:bg-white object-contain opacity-40 blur-3xl'></div>
          </div>
          <span
            className={`pl-3 font-rock-salt text-6xl font-extrabold transition-all text-black dark:text-stone-100`}
          >
            BitEnvious
          </span>
        </div>
