  ...
  return (
    <section className='group who-we-are'>
      ...
      <div className='relative m-auto w-full max-w-[1340px] flex p-8 text-center md:p-12 md:text-right lg:my-24 lg:px-16'>
        <div className='about-logo relative flex flex-col md:flex-row items-center mx-auto'>
          <div className="relative">
            <Image
              ...
              width={250}
              height={250}
              className='transition-all duration-2000 grayscale group-hover:grayscale-0 relative z-20 mb-6 md:mb-0'
            />
