...
export const metadata = {
  Title:
    'Contact BitEnvious: Strategic Web Design & Digital Marketing in Knoxville, TN',
  Description:
    'Ready to elevate your business? Contact BitEnvious in Knoxville, TN, today to discuss your web design, digital marketing, or strategic consulting needs.',
}
  ...
  return (
    <main>
      <PageTitle
        ...
        headingClassNames="bg-gradient-to-r from-yellow-600 to-amber-400 bg-clip-text text-transparent"
      />
      <PageLoad offset={50}>
        <section>
          <div className="m-auto max-w-[1340px] sm:grid md:grid-cols-3">
            <div className="border-t p-8 pt-16 lg:pt-24 lg:text-right">
              <div className="top-32 lg:sticky">
                ...
                <div className="text-lg font-light lg:text-xl">
                  <p>
                    Ready to bring your digital vision to life and reshape your
                    online presence? Take the first step by contacting us today!
                  </p>
                </div>
              </div>
            </div>
            <div className="md:col-span-2 md:pr-8">
              <div className="sm:grid md:grid-cols-2">
                <div className="text-md border-l border-t p-8 md:text-lg lg:border-t-0 lg:pt-24">
                ...
                <div className="border-l border-t p-8 sm:col-span-2">
                  ...
                  <p className="text-lg">
                    ...
                    lasting impact in the digital world? Look no further! Our
                    team of experts is here to transform your vision into a
                    stunning reality. Whether you&apos;re a small business
                    looking to establish your online presence or a large
                    corporation in need of a website refresh, we&apos;ve got you
                    covered. With a focus on creativity, functionality, and user
                    experience, we&apos;ll work closely with you to craft a
                    bespoke website that captures the essence of your brand and
                    engages your audience. Don&apos;t settle for mediocrity when
                    you can have excellence. Reach out today to schedule a
                    consultation and let&apos;s take your online presence to new
                    heights!
                  </p>
                </div>
              </div>
              ...
              <div className="top-32 lg:sticky">
                ...
                <div className="text-lg font-light lg:text-xl">
                  <p>
                    ...
                    and revolutionize your online presence? Contact us today to
                    take the first step!
                  </p>
                </div>
              </div>
          ...
          <div className="m-auto max-w-[1340px] sm:grid md:grid-cols-3">
            <div className="border-t p-8 pt-16 lg:pt-24 lg:text-right">
              <div className="top-32 lg:sticky">
                ...
                <div className="text-lg font-light lg:text-xl">
                  <p>
                    Let&rsquo;s chat! Schedule a meeting with us today to
                    discuss your digital needs and take the first step towards
