...
export const metadata = {
  title:
    'News, Trends & Marketing Insights, Design & Development Tips | BitEnvious Blog',
  description:
    'Stay ahead of the curve with BitEnvious blog, featuring the latest trends, strategies, and tips in digital marketing, web design, and brand identity. Read our expert insights today!',
}

export default async function Blog() {
  const endpoint =
    '/api/posts?populate[heroImage][fields][0]=formats&fields[0]=title&fields[2]=slug&pagination[pageSize]=20&pagination[page]=1&publicationState=live&locale[0]=en&fields[1]=publishedDate&populate[category][fields][0]=Name&populate[category][fields][1]=slug&sort=publishedDate:DESC'
  ...
  return (
    <main>
      <PageTitle
        ...
        headingClassNames="bg-gradient-to-r from-gray-200 to-stone-400 bg-clip-text text-transparent"
      />
      <PageLoad offset={50}>
        <TitleSectionWidget
